...
export type GetMySettingsQuery = { getMySettings: { employeeNumber: number, productPreset: string | null, activityPreset: string | null, projectsPreset: Array<string> | null, jiraNotificationIgnore: boolean | null, showWeekend: boolean | null, setRemainingHours: boolean | null, showJiraIssueStatus: boolean | null } };
