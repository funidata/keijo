...
export type GetMySettingsQuery = { getMySettings: { employeeNumber: number, productPreset: string | null, activityPreset: string | null, projectsPreset: Array<string> | null, jiraNotificationIgnore: boolean | null, showWeekend: boolean | null, setRemainingHours: boolean | null, showJiraIssueStatus: boolean | null, entryTemplates: Array<{ key: string, templateName: string, duration: number, description: string, product: string | null, activity: string | null, issue: string | null, client: string | null }> | null } };
...
export type AddEntryTemplateMutationVariables = Exact<{
  template: Types.EntryTemplateInput;
}>;


export type AddEntryTemplateMutation = { addEntryTemplate: { employeeNumber: number, entryTemplates: Array<{ key: string, templateName: string, duration: number, description: string, product: string | null, activity: string | null, issue: string | null, client: string | null }> | null } };

export type ReplaceEntryTemplateMutationVariables = Exact<{
  input: Types.ReplaceEntryTemplateInput;
}>;


export type ReplaceEntryTemplateMutation = { replaceEntryTemplate: { employeeNumber: number, entryTemplates: Array<{ key: string, templateName: string, duration: number, description: string, product: string | null, activity: string | null, issue: string | null, client: string | null }> | null } };

export type RemoveEntryTemplateMutationVariables = Exact<{
  templateKey: Types.RemoveEntryTemplateInput;
}>;


export type RemoveEntryTemplateMutation = { removeEntryTemplate: { employeeNumber: number, entryTemplates: Array<{ key: string, templateName: string, duration: number, description: string, product: string | null, activity: string | null, issue: string | null, client: string | null }> | null } };
...
export const GetMyOverviewConfigDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetMyOverviewConfig"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getMyOverviewConfig"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"groupBy"}},{"kind":"Field","name":{"kind":"Name","value":"graphs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"variant"}}]}}]}}]}}]} as unknown as DocumentNode<GetMyOverviewConfigQuery, GetMyOverviewConfigQueryVariables>;
export const UpdateMyOverviewConfigDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateMyOverviewConfig"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"config"}},"type":{"kind":"NonNullType","type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"OverviewZoneInput"}}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateMyOverviewConfig"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"config"},"value":{"kind":"Variable","name":{"kind":"Name","value":"config"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"groupBy"}},{"kind":"Field","name":{"kind":"Name","value":"graphs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"variant"}}]}}]}}]}}]} as unknown as DocumentNode<UpdateMyOverviewConfigMutation, UpdateMyOverviewConfigMutationVariables>;
...
export const ReplaceEntryTemplateDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReplaceEntryTemplate"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ReplaceEntryTemplateInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"replaceEntryTemplate"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"employeeNumber"}},{"kind":"Field","name":{"kind":"Name","value":"entryTemplates"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"key"}},{"kind":"Field","name":{"kind":"Name","value":"templateName"}},{"kind":"Field","name":{"kind":"Name","value":"duration"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"product"}},{"kind":"Field","name":{"kind":"Name","value":"activity"}},{"kind":"Field","name":{"kind":"Name","value":"issue"}},{"kind":"Field","name":{"kind":"Name","value":"client"}}]}}]}}]}}]} as unknown as DocumentNode<ReplaceEntryTemplateMutation, ReplaceEntryTemplateMutationVariables>;
