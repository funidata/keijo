...
export type AddEntryTemplateMutation = { addEntryTemplate: { employeeNumber: number } };
...
export type RemoveEntryTemplateMutation = { removeEntryTemplate: { employeeNumber: number } };
